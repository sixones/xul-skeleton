...
and use find + replace across all the files
	...
	@_APP_NAME_@ - Application name (without spaces), use the folder name of your project

	@_APP_DISPLAY_NAME_@ - Application display name
	
	@_APP_VERSION_@ - Version string
	
	@_APP_VENDOR_@ - Vendor name
	
	@_APP_ID_@ - Unique application id, usually something like org.sixones@zenses or a GUID
	
	@_APP_COPYRIGHT_@ - Copyright notice
	
	@_MAIN_CHROME_@ - The default xul chrome file to launch on startup, dont include the .xul extension
	
	@_IDL_UUID_@ - Random GUID for your first idl header
